...
setwd("/Users/sageloeppky/Desktop/Keystone_Data" )
wk.dir<-getwd() 
list.files()

#"/Users/sageloeppky/Desktop/Keystone_Data" This is the working directory 

# location of thee working directory
## var.name.1 <- "something" # important variable doing....
## var.name.2 <- "something.different" #
# set working dir to "~/Desktop/Keystone_Data"
# === libraries ================================================================
